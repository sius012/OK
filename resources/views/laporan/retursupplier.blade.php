...
<body>
    <div class="container-wrapper">
        <table style="margin-top: 30px;">
            ...
            @foreach($data2["content"] as $i => $datas)
                <tr>
                    @if($i == 0)
                    <th valign="top" align="left">Barang yang di retur</th>
                    @else
                    <td></td>
                    @endif
                    <td valign="top" style="width:50px" > {{$datas['jumlah']}} {{$datas['satuan']}}</td>
                    <td  valign="top" style="width:350px">{{$datas['nama_produk']}}</td>
...
<td colspan="3">{{$data2["keterangan"]}}</td>
